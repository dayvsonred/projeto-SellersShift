...
@Component({
  selector: 'app-dashboard-buy-finality',
  templateUrl: './dashboard-buy-finality.component.html',
  styleUrls: ['./dashboard-buy-finality.component.css']
})
export class DashboardBuyFinalityComponent implements OnInit {
  currentUser: any;
  produtos: any;
  produto: any;
